...
//            {new iOSDriver().getPageObject()},
            ...
            {new CommonLoginPage(new ChromeDriver()).navigateTo()},
            {new CommonLoginPage(new FirefoxDriver()).navigateTo()},
        }
    );
  }
  ...
  public void newChatterPostTest() throws Exception {
    ...
    String postText = "Doing a demo with Page Objects at #seleniumconf on " +
